...
Usage:
    aideus pairing list              # Show all pending + approved users
    aideus pairing approve <platform> <code>  # Approve a pairing code
    aideus pairing revoke <platform> <user_id> # Revoke user access
    aideus pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle aideus pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: aideus pairing {list|approve|revoke|clear-pending}")
        print("Run 'aideus pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'aideus pairing list' to see pending codes.\n")
