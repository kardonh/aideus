"""
Skills configuration for Aideus Agent.
`aideus skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.aideus/config.yaml under:
...
from aideus_cli.config import cfg_get, load_config, save_config
from aideus_cli.colors import Colors, color
from aideus_cli.platforms import PLATFORMS as _PLATFORMS
