# Streaming LLM Response Support for Aideus Agent
...
```
AIDEUS_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("AIDEUS_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `aideus_cli/config.py` | 1 | +streaming config defaults |
