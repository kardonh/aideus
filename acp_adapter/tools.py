"""ACP tool-call helpers for mapping aideus tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map aideus tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a aideus tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    """Create a ToolCallStart event for the given aideus tool invocation."""
