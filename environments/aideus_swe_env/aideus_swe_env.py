"""
AideusSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser aideus
    run-api
    python environments/aideus_swe_env.py serve \\
...
class AideusSweEnv(AideusAgentBaseEnv):
    ...
    name = "aideus-swe"
    env_config_cls = AideusSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[AideusSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = AideusSweEnvConfig(
            ...
            tool_call_parser="aideus",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="aideus-swe",
        )
