...
Inspired by: GroceryMind — production Aideus agent doing live web research
             across German grocery stores (firecrawl + aideus-agent)
"""
...
# Ensure aideus-agent root is on path
...
class WebResearchEnvConfig(AideusAgentEnvConfig):
...
class WebResearchEnv(AideusAgentBaseEnv):
    """
