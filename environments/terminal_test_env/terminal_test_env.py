...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Aideus Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Aideus Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Aideus Agent",
    },
    {
...
class TerminalTestEnv(AideusAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/aideus-agent/.env.
        """
