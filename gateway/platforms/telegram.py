...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("AIDEUS_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
        ...
        self._text_batch_delay_seconds = float(os.getenv("AIDEUS_TELEGRAM_TEXT_BATCH_DELAY_SECONDS", "0.6"))
        self._text_batch_split_delay_seconds = float(os.getenv("AIDEUS_TELEGRAM_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0"))
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "(possibly OpenClaw or another Aideus instance). "
            "Aideus stopped Telegram polling after %d retries. "
            "Only one poller can run per token — stop the other process "
            "and restart with 'aideus start'."
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            request_kwargs = {
                "connection_pool_size": _env_int("AIDEUS_TELEGRAM_HTTP_POOL_SIZE", 512),
                "pool_timeout": _env_float("AIDEUS_TELEGRAM_HTTP_POOL_TIMEOUT", 8.0),
                "connect_timeout": _env_float("AIDEUS_TELEGRAM_HTTP_CONNECT_TIMEOUT", 10.0),
                "read_timeout": _env_float("AIDEUS_TELEGRAM_HTTP_READ_TIMEOUT", 20.0),
                "write_timeout": _env_float("AIDEUS_TELEGRAM_HTTP_WRITE_TIMEOUT", 20.0),
            }

            disable_fallback = (os.getenv("AIDEUS_TELEGRAM_DISABLE_FALLBACK_IPS", "").strip().lower() in ("1", "true", "yes", "on"))
            ...
            try:
                ...
                from aideus_cli.commands import telegram_menu_commands
    ...
    def _message_mentions_bot(self, message: Message) -> bool:
        ...
        # raw substring matches like "foo@aideus_bot.example" are not mentions
