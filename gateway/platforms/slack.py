...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_aideus_home() / "slack_tokens.json"
        ...
        try:
            ...
            # /model work directly without /aideus prefix). A single regex
            ...
            # manifest (see `aideus slack manifest`). In Socket Mode, Slack
            ...
            from aideus_cli.commands import slack_native_slashes
            import re as _re
            ...
            if _slash_names:
                ...
                _slash_pattern = _re.compile(r"^/aideus$")

            @self._app.command(_slash_pattern)
            async def handle_aideus_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "aideus_approve_once",
                "aideus_approve_session",
                "aideus_approve_always",
                "aideus_deny",
            ):
            ...
            for _action_id in (
                "aideus_confirm_once",
                "aideus_confirm_always",
                "aideus_confirm_cancel",
            ):
    ...
    def _dm_top_level_threads_as_sessions(self) -> bool:
        ...
        own Aideus session — matching the per-thread behavior channels already
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "aideus_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "aideus_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "aideus_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "aideus_confirm_once",
                            "value": value,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Approve"},
                            "action_id": "aideus_confirm_always",
                            "value": value,
                        },
                        {
                            "type": "button",
                            ...
                            "style": "danger",
                            "action_id": "aideus_confirm_cancel",
                            "value": value,
                        },
                    ],
                },
    ...
    async def _handle_slash_confirm_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "aideus_confirm_once": "once",
            "aideus_confirm_always": "always",
            "aideus_confirm_cancel": "cancel",
        }
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "aideus_approve_once": "once",
            "aideus_approve_session": "session",
            "aideus_approve_always": "always",
            "aideus_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        The legacy ``/aideus <subcommand> [args]`` form is preserved for
        backward compatibility with older workspace manifests and for users
        who want a single entry point for free-form questions (``/aideus
        ...
        if slash_name in ("aideus", ""):
            # Legacy /aideus <subcommand> [args] routing + free-form questions.
            # Empty slash_name falls into this branch for backward compat
            # with any caller that didn't populate command["command"].
            from aideus_cli.commands import slack_subcommand_map
