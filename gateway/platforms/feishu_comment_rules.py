...
Config: ~/.aideus/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.aideus/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_aideus_home()`` helper (AIDEUS_HOME-aware and
...
RULES_FILE = get_aideus_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_aideus_home() / "feishu_comment_pairing.json"
