...
try:
    ...
    _AIDEUS_VERSION = "0.0.0"

_APP_VERSION = _AIDEUS_VERSION
_BOT_VERSION = _AIDEUS_VERSION
_YUANBAO_INSTANCE_ID = str(AIDEUS_INSTANCE_ID)  # single source: yuanbao_proto.AIDEUS_INSTANCE_ID
