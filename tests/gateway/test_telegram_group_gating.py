...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @aideus_bot", entities=[_mention_entity("hi @aideus_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message(
            "/status@aideus_bot",
            entities=[_bot_command_entity("/status@aideus_bot", "/status@aideus_bot")],
        ),
        is_command=True,
    ) is True
