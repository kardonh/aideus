...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from aideus_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in AIDEUS_OVERLAYS
        overlay = AIDEUS_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify aideus doctor recognizes Xiaomi env vars."""
