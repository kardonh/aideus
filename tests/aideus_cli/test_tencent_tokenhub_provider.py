...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_models_py(self):
        from aideus_cli.models import normalize_provider
    ...
    def test_normalize_provider_providers_py(self):
        from aideus_cli.providers import normalize_provider
        assert normalize_provider("tencent") == "tencent-tokenhub"
        assert normalize_provider("tokenhub") == "tencent-tokenhub"
        assert normalize_provider("tencent-cloud") == "tencent-tokenhub"
        assert normalize_provider("tencentmaas") == "tencent-tokenhub"
...
# =============================================================================
# CANONICAL_PROVIDERS (aideus model picker)
# =============================================================================
...
class TestTencentInOpenRouterAndNous:
    ...
    def test_in_openrouter_fallback(self):
        from aideus_cli.models import OPENROUTER_MODELS
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from aideus_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from aideus_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in AIDEUS_OVERLAYS
        overlay = AIDEUS_OVERLAYS["tencent-tokenhub"]
    ...
    def test_get_provider(self):
        pdef = None
        try:
            from aideus_cli.providers import get_provider
...
class TestTencentTokenhubDoctor:
    """Verify aideus doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from aideus_cli.providers import AIDEUS_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = AIDEUS_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``aideus model`` routes it through the generic api_key_provider flow.
        """
        import inspect
        from aideus_cli import main as main_mod
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from aideus_cli.models import _KNOWN_PROVIDER_NAMES
