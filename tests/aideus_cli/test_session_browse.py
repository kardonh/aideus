"""Tests for the interactive session browser (`aideus sessions browse`).
...
from aideus_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """aideus sessions browse should be parseable."""
        from aideus_cli.main import main as _main_entry
