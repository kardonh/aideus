...
The main() function in aideus_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `aideus -c model`
...
def _build_parser():
    """Build a minimal replica of the aideus top-level parser."""
