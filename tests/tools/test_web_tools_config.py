...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_aideus_home_override(self, tmp_path):
        """Auth lookup should read from AIDEUS_HOME/auth.json, not ~/.aideus/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".aideus").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``aideus tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
