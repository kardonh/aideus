...
def _restore_tool_modules():
    original_aideus_home = os.environ.get("AIDEUS_HOME")
    original_modules = {
        name: module
    ...
    try:
        ...
        if original_aideus_home is None:
            os.environ.pop("AIDEUS_HOME", None)
        else:
            os.environ["AIDEUS_HOME"] = original_aideus_home
        _reset_modules(("tools", "aideus_cli", "modal"))
...
def _install_modal_test_modules(
    ...
    *,
    ...
    aideus_cli = types.ModuleType("aideus_cli")
    aideus_cli.__path__ = []  # type: ignore[attr-defined]
    sys.modules["aideus_cli"] = aideus_cli
    aideus_home = tmp_path / "aideus-home"
    os.environ["AIDEUS_HOME"] = str(aideus_home)
    sys.modules["aideus_cli.config"] = types.SimpleNamespace(
        get_aideus_home=lambda: aideus_home,
    )
    ...
    async def _lookup_aio(_name: str, create_if_missing: bool = False):
        return types.SimpleNamespace(name="aideus-agent", create_if_missing=create_if_missing)
    ...
    return {
        "snapshot_store": aideus_home / "modal_snapshots.json",
