...
def _enable_managed_nous_tools(monkeypatch):
    ...
    aideus_cli.auth and aideus_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("aideus_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("aideus_cli.models.check_nous_free_tier", lambda: False)
