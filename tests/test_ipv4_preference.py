...
def _reload_constants():
    """Reload aideus_constants to get a fresh apply_ipv4_preference."""
    import aideus_constants
    importlib.reload(aideus_constants)
    return aideus_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_aideus_ipv4_patched", False) is True
