...
def rate_guard_env(tmp_path, monkeypatch):
    ...
    aideus_home = str(tmp_path / ".aideus")
    os.makedirs(aideus_home, exist_ok=True)
    monkeypatch.setenv("AIDEUS_HOME", aideus_home)
...
class TestIsGenuineNousRateLimit:
    ...
    Nous Portal multiplexes upstreams (DeepSeek, Kimi, MiMo, Aideus).
