...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("aideus_cli.config.get_config_path", return_value=config_path), \
             patch("aideus_cli.config.ensure_aideus_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("aideus_cli.config.get_env_path", return_value=env_path), \
             patch("aideus_cli.config.ensure_aideus_home"):
    ...
    def test_ensure_aideus_home_sets_0700(self):
        home = Path(self.tmpdir) / ".aideus"
        with patch("aideus_cli.config.get_aideus_home", return_value=home):
