# Aideus Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.aideus/plugins/aideus-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.aideus/plugins/aideus-achievements/scan_checkpoint.json`.
