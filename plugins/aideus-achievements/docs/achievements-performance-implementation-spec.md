# Aideus Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.aideus/plugins/aideus-achievements/state.json` (existing unlock state)
  - `~/.aideus/plugins/aideus-achievements/scan_snapshot.json` (new)
  - `~/.aideus/plugins/aideus-achievements/scan_checkpoint.json` (new)
