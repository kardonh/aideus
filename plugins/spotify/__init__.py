...
``_check_spotify_available()`` — when the user has not run ``aideus auth
spotify``, the tools remain registered (so they appear in ``aideus
...
The Spotify auth flow (``aideus auth spotify``), CLI plumbing, and docs
