...
```python
import sys
sys.path.insert(0, "/home/teknium/.aideus/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.aideus/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Aideus installs package this)
