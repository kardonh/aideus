...
Built for [Aideus](https://github.com/Kardonh/aideus). Usable in any coding agent. Canonical source lives here; synced to [`Kardonh/aideus/skills/creative/ascii-video`](https://github.com/Kardonh/aideus/tree/main/skills/creative/ascii-video) via PR.
