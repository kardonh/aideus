...
```bash
python3 -m pyfiglet "AIDEUS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=AIDEUS&font=Slant" | boxes -d stone
```
