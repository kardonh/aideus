...
Data file: $AIDEUS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_AIDEUS_HOME = Path(os.environ.get("AIDEUS_HOME", Path.home() / ".aideus"))
DATA_DIR = _AIDEUS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
