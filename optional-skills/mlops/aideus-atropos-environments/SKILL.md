---
name: aideus-atropos-environments
description: Build, test, and debug Aideus Agent RL environments for Atropos training. Covers the AideusAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the aideus-agent repo.
version: 1.1.0
author: Aideus Agent
license: MIT
metadata:
