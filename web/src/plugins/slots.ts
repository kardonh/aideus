 ...
 * `window.__AIDEUS_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Aideus brand in the top bar
 ...
 *  `window.__AIDEUS_PLUGINS__.registerSlot(...)`.
 *
