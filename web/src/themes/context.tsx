...
const STORAGE_KEY = "aideus-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `aideus_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "aideus-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-aideus-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-aideus-theme-font", "true");
