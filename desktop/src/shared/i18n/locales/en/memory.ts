export default {
  title: "Memory",
  subtitle:
    "What Aideus remembers about you and your environment across sessions.",
  sessions: "Sessions",
  messages: "Messages",
  memories: "Memories",
  ...
  noMemoriesYet: "No memories yet. Aideus will save important facts as you chat.",
  ...
  userProfileHint: "Tell Aideus about yourself — name, role, preferences, communication style.",
  providersHint: "Pluggable memory providers give Aideus advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",
