export default {
  ...
  poolHint: "Add multiple API Keys for the same provider for automatic rotation and load balancing. Aideus will cycle through them.",
  add: "Add",
  remove: "Remove",
  keyLabel: "Key",
  empty: "(empty)",
  dataSection: "Data",
  dataHint: "Export or import your Aideus configuration, sessions, skills, and memory.",
  ...
  migrationDesc: "Found OpenClaw at <code>{{path}}</code>. You can migrate your configuration, API keys, sessions, and skills to Aideus.",
  migrationDismiss: "Don't show again",
  migrating: "Migrating...",
  migrateToAideus: "Migrate to Aideus",
  skip: "Skip",
  ...
  modeLocal: "Local",
  modeRemote: "Remote",
  modeLocalHint: "Using Aideus installed on this device",
  modeRemoteHint: "Connect to a Aideus API server on your network or cloud",
  remoteUrl: "Remote URL",
  remoteUrlHint: "The Aideus API server URL (must expose /health and /v1/chat/completions)",
  ...
  serverConfigHint: "You&apos;re connected to a remote Aideus server. Model selection, provider API keys, and credentials are managed on the server&apos;s <code>~/.aideus/.env</code> and <code>config.yaml</code>. Edit them on the host (e.g. <code>docker exec -it aideus vi /opt/data/.env</code>) and restart the container.",
  connectionMode: "Mode",
