...
| [`aideus-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-aideus-agent) | Configure, extend, or contribute to Aideus Agent. | `autonomous-ai-agents/aideus-agent` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-aideus-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-aideus-tui-commands) | Debug Aideus TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-aideus-tui-commands` |
| [`aideus-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-aideus-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/aideus-agent-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write markdown plan to .aideus/plans/, no exec. | `software-development/plan` |
