---
title: "Aideus Agent — Configure, extend, or contribute to Aideus Agent"
sidebar_label: "Aideus Agent"
...
Configure, extend, or contribute to Aideus Agent.
...
| Path | `skills/autonomous-ai-agents/aideus-agent` |
| Version | `2.0.0` |
