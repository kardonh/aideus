...
| | |
|---|---|
| Source | Optional — install with `aideus skills install official/health/neuroskill-bci` |
...
Connect Aideus to a running [NeuroSkill](https://neuroskill.com/) instance to read
