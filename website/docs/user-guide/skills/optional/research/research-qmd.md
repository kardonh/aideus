...
| | |
|---|---|
| Source | Optional — install with `aideus skills install official/research/qmd` |
...
Aideus Agent via the native MCP client. This is the preferred
...
Then configure Aideus Agent to connect via HTTP:
