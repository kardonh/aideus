...
| | |
|---|---|
| Source | Optional — install with `aideus skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/Kardonh/aideus/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/Kardonh/aideus/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
