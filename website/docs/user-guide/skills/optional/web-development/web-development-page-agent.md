...
- User wants **Aideus itself to drive a browser** → use Aideus' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
