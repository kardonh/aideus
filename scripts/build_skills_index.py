#!/usr/bin/env python3
"""Build the Aideus Skills Index — a centralized JSON catalog of all skills.
...
`aideus skills search/install` can use it without hitting the GitHub API.
...
# Ensure AIDEUS_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Aideus Skills Index...", flush=True)
