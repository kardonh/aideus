#!/usr/bin/env python3
"""Build the Aideus Model Catalog — a centralized JSON manifest of curated models.
...
Aideus CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Aideus release.
...
# Ensure AIDEUS_HOME is set for imports that touch it at module level.
os.environ.setdefault("AIDEUS_HOME", os.path.join(os.path.expanduser("~"), ".aideus"))

from aideus_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "aideus-agent repo",
            "docs": "https://aideus-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
