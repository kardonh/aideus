#!/usr/bin/env bash
# Canonical test runner for aideus-agent. Run this instead of calling
...
VENV=""
for candidate in "$REPO_ROOT/.venv" "$REPO_ROOT/venv" "$HOME/.aideus/aideus-agent/venv"; do
...
# Unset AIDEUS_* behavioral vars too.
unset AIDEUS_YOLO_MODE AIDEUS_INTERACTIVE AIDEUS_QUIET AIDEUS_TOOL_PROGRESS \
      AIDEUS_TOOL_PROGRESS_MODE AIDEUS_MAX_ITERATIONS AIDEUS_SESSION_PLATFORM \
      AIDEUS_SESSION_CHAT_ID AIDEUS_SESSION_CHAT_NAME AIDEUS_SESSION_THREAD_ID \
      AIDEUS_SESSION_SOURCE AIDEUS_SESSION_KEY AIDEUS_GATEWAY_SESSION \
      AIDEUS_PLATFORM AIDEUS_INFERENCE_PROVIDER AIDEUS_MANAGED AIDEUS_DEV \
      AIDEUS_CONTAINER AIDEUS_EPHEMERAL_SYSTEM_PROMPT AIDEUS_TIMEZONE \
      AIDEUS_REDACT_SECRETS AIDEUS_BACKGROUND_NOTIFICATIONS AIDEUS_EXEC_ASK \
      AIDEUS_HOME_MODE 2>/dev/null || true
