...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - aideus_home (str): The active AIDEUS_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.aideus``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "aideus").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'aideus memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], aideus_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'aideus memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``aideus_home`` is the active AIDEUS_HOME directory path.
