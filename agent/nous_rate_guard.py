...
(3 SDK retries x 3 Aideus retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_aideus_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".aideus")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Aideus, ...) behind one endpoint.  A 429 can mean either:
