...
def auth_json_path():
    """Return the Aideus auth store path, respecting AIDEUS_HOME overrides."""
    return get_aideus_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from aideus_cli.auth import resolve_nous_access_token
