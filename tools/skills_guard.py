...
Trust levels:
  - builtin:   Ships with Aideus. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.aideus/\.env|\~/\.aideus/\.env',
     "aideus_env_access", "critical", "exfiltration",
     "directly references Aideus secrets file"),
    ...
    (r'\.aideus/config\.yaml|\.aideus/SOUL\.md',
     "aideus_config_mod", "critical", "persistence",
     "references Aideus configuration files directly"),
