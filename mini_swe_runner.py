#!/usr/bin/env python3
"""
SWE Runner with Aideus Trajectory Format

A runner that uses Aideus-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Aideus-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Aideus-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Aideus format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Aideus-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Aideus-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Aideus Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Aideus-Agent's built-in execution environments
    and outputs trajectories in Aideus-Agent format.
    """
    ...
    def _convert_to_aideus_format(
        ...
        """
        Convert internal message format to Aideus trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Aideus trajectory format
        trajectory = self._convert_to_aideus_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Aideus trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Aideus Trajectory Format")
    print("=" * 60)
